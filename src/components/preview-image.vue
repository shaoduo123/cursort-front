...
<!--                </svg>-->
<!--            </div>-->
<!--            <div class="owl-preview-operate-item owl-preview-operate-item-right" @click="next">-->
...
.owl-preview-operate-item-left {
  left: 5vw;
}
.owl-preview-operate-item-right {
  right: 5vw;
}
.owl-preview-operate .owl-preview-operate-icon {
  font-size: 24px;
  color: #ffffff;
}
.owl-preview-operate .owl-preview-operate-icon-left {
  transform: rotate(180deg);
}
.owl-preview .owl-preview-utils {
  position: absolute;
  bottom: 5%;
  left: 50%;
...
.owl-preview .owl-preview-utils-item {
  cursor: pointer;
  margin: 0 10px;
  color: white;
  font-size: 24px;
}
.owl-preview .owl-preview-utils-scale {
  font-size: 14px;
  position: relative;
  background-color: #606266;
...
.owl-preview .owl-preview-utils-scale::before, .owl-preview .owl-preview-utils-scale::after {
  position: absolute;
  width: 100%;
  height: 100%;
  content: "";
...
.owl-preview .owl-preview-utils-scale::before {
  height: 12px;
  top: 50%;
  margin-top: -6px;
  width: 34px;
...
.owl-preview .owl-preview-utils-scale::after {
  height: 24px;
  width: 20px;
  top: -1px;
  left: 50%;
